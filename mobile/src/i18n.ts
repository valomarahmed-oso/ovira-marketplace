...
const ar = {
  ...
  returnPickItems: "المنتجات اللي هترجّعها",
  returnWhole: "هيترجّع الطلب كله — أو اختر منتجات معيّنة",
...
const en: Dict = {
  ...
  returnReason: "Reason",
  returnPickItems: "What are you returning?",
  returnWhole: "The whole order — or pick specific items",
