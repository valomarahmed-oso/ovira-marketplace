    ...
    <div className="scrollbar-none -mx-1 flex gap-3 overflow-x-auto px-1 pb-2">
      {categories.map((c) => {
        ...
        return (
          ...
          >
            <span className="grid h-16 w-16 place-items-center rounded-2xl border border-line bg-white transition-colors group-hover:border-blue group-hover:bg-blue-50">
