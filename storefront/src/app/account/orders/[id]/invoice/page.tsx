    ...
    <div className="space-y-4">
      ...
      <div id="invoice" className="card space-y-6 p-6 sm:p-8">
        ...
        <div className="flex flex-wrap items-start justify-between gap-4 border-b border-line pb-5">
          <div>
            <div className="font-tech text-xl font-bold text-ink">أوفيرا ماركت بليس</div>
            <div className="mt-1 text-xs text-ink-400">Ovira Marketplace · demo.ovira.cloud</div>
          </div>
          <div className="text-left">
            <div className="text-lg font-medium text-ink">فاتورة</div>
        ...
        <div className="grid gap-5 sm:grid-cols-2">
          <div className="space-y-1">
            <div className="text-xs font-medium uppercase tracking-wide text-ink-400">فاتورة إلى</div>
          ...
          <div className="space-y-1 sm:text-left">
            <div className="text-xs font-medium uppercase tracking-wide text-ink-400">تفاصيل</div>
            <div className="text-sm text-ink-600">
              الحالة:{" "}
            ...
            <div className="text-sm text-ink-600">
              حالة الدفع: <span className="text-ink">{order.payment_status || "—"}</span>
            </div>
            <div className="text-sm text-ink-600">
              طريقة الدفع: <span className="text-ink">{payLabel}</span>
            </div>
          </div>
        </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-line text-right text-xs text-ink-400">
                ...
                <th className="py-2 text-left font-medium">سعر الوحدة</th>
        ...
        <div className="ml-auto max-w-xs space-y-1.5">
          ...
          <div className="flex justify-between text-sm text-ink-600">
            ...
            <span className="font-tech text-ink">
              {order.shipping_amount === 0 ? "مجاني" : formatPrice(order.shipping_amount, order.currency)}
            </span>
          </div>
        ...
        <div className="border-t border-line pt-4 text-center text-xs text-ink-400">
          شكرًا لتسوّقك من أوفيرا · هذه الفاتورة صادرة إلكترونيًا ولا تحتاج توقيعًا.
        </div>
      </div>
    </div>
  );
