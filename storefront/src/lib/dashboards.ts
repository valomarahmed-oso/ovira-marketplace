...
export const DASHBOARDS: Record<DashboardRole, DashboardDef> = {
  operator: {
    ...
    nav: [
      ...
      { href: "/admin/cod-risk", key: "adminNavCodRisk", icon: ShieldAlert },
      ...
      { href: "/admin/support", key: "adminNavSupport", icon: LifeBuoy },
      ...
      { href: "/admin/currencies", key: "adminNavCurrencies", icon: Coins },
      { href: "/admin/email", key: "adminNavEmail", icon: Mail },
      { href: "/admin/messaging", key: "adminNavMessagingHub", icon: RadioTower },
      { href: "/admin/notifications", key: "adminNavNotifications", icon: BellRing },
  ...
  buyer: {
    ...
    nav: [
      ...
      { href: "/account/support", key: "supNav", icon: LifeBuoy },
